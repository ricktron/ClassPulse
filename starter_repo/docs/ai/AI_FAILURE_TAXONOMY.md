...
- Fix by moving to canonical owner file and regenerating derived outputs through workflow.

### Over-broad patch
- Diff exceeds bounded slice or includes unrelated cleanup.
- Fix by shrinking to the scoped change or splitting into follow-up intake.
...
- Required intake/packet/review/closeout artifact was skipped.
- Fix by backfilling the artifact honestly and rerunning verification as needed.

### Contract drift
- Implementation and stated contract/decision no longer align.
- Fix by either realigning implementation or explicitly updating contract/decision.

## Related docs

- [../WORKFLOWS/AI_TOOL_ROUTING.md](../WORKFLOWS/AI_TOOL_ROUTING.md)
